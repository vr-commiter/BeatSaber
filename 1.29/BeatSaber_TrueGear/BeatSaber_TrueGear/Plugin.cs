    ...
    public class Plugin
    {
        ...
        */
        ...
        public void OnApplicationStart()
        {
            ...
            new GameObject("TrueGearController").AddComponent<BeatSaber_TrueGearController>();
        ...
        public static IEnumerable<CodeInstruction> ObstacleSaberSparkleTranspiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            var playHapticFeedbackMethod = typeof(HapticFeedbackController).GetMethod("PlayHapticFeedback");
